...
export default function About() {
    ...
    return (
        <section id='about' className='min-h-screen font-mono flex items-center justify-center px-20'>
            <RevealOnScroll>
                <div className='max-w-3xl mx-auto px-4'>
                    <h2 className='max-w-3xl text-4xl font-semibold mb-12 bg-gradient-to-r from-teal-500 
                        ...
                        <div className='rounded-xl p-6 hover:-translate-y-1 transition-all'>
                            ...
                            <div className='flex justify-center flex-wrap gap-2'>
                                {skills.map((skill, index) => (
                                    <span key={index} className='bg-blue-500 text-blue-400 py-1 px-3 rounded-full text-balance
                                hover:bg-blue-500/20 hover:shadow-[9_2px_8px_rgba(59,130,22,46,0.2)] transition cursor-pointer'>{skill}</span>
                                ))}
                            </div>
                        </div>
